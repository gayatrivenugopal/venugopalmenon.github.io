...
const excerptData = {
  ...
  "city-of-london": {
    ...
    sections: [
      ...
      {
        heading: "Portraits of London",
        paragraphs: [
          "This afternoon I spent a lot of time standing on the Waterloo Bridge and looking down at river Thames and observing the life in motion all around it.",
          "The river meanders beautifully here forming a bend and flows in rhythmic coquetry. A little far on the right bank the Parliament Houses and the Big Ben tower stand like displays set in a glass case—on the other bank are Savoy Hotel and the darkened railway bridge. 'Cleopatra's Needle' and the black Sphinx statues at its base present another spectacle. Far away on another side the dome of Saint Paul's Cathedral appears to be a cheppukudam [pot of copper] dipped in the celestial pond.",
          "The white painted ships and the boats and the tugs that spew black smoke—all together make the expanse of the river a bizarre Narthana Mandapam [a stage for dance performances].",
          "Most of the docks destroyed by Hitler's bombing still remain in the same state. The outlines of renovation stand prominently in some corners...",
          "Below, on the roads on the bank of the river is the perennial flow of motor cars and other vehicles...lures of the new life!",
          "A board on London streets cautioning pedestrians:",
          "'Impatience to cross streets",
          "Creates in-patients in Hospitals.'",
          "The advertisement for Abdulla cigarette:",
          "'Abdulla—King of cigarettes",
          "Cigarette of Kings.'",
          "In the underground railway there are cars with separate compartments where smoking is not allowed and compartments where it is allowed. Of these the board displayed in the former was this: 'No smoking—Not even Abdullah.'",
          "That this advertisement is sponsored by the Abdullah Company goes without saying.",
          "The public lavatories in London city are all constructed below ground level. When we see the cleanliness and quality of these toilets we will be wonderstruck. Some personalized advices, appropriate to the occasion to make you better citizens are also arranged here.",
          "When you relieve yourself standing, a pointedly scripted signage glares at you:",
          "'Have you checked for venereal disease?'",
          "(This could mean to ask if you have taken precautions against contracting sexually transmitted diseases.)",
          "If you suspect that you are mentally unstable, you will be restless till you meet a doctor. That is for sure.",
          "When you are done and turn around, another board draws your attention: 'Have you buttoned your trousers properly?'",
          "A query like a slap in the face for people who suffer short term memory loss!",
          "London's climate is quite deceptive. A day dawned when it looked like it was winter—cold that turned the veins and nerves to strands of coir. That evening I was at Hyde Park in the stillness of intense cold. In the hazy atmosphere, the buildings appeared like palaces of lead. The western moon in the sky beamed like the silver hands of the clock of eternity over the colorful incandescent fiesta of the neon lights of Park Lane. A cluster of clouds on the horizon erect for the city of London mystical mountains. I couldn't help but stand and stare at that marvelous scene...rarely does nature perform such shows in London.",
          "A girl rubbed past me aggressively today in the crowd of people in the corridor of Selfridge's (a large trading company in London) and turned and said with a sweet smile: ''Scueese me!' What she said could be in English, 'Excuse me' or 'Squeeze me.' There are many words and usages in English whose meaning is queerly altered by the way they are pronounced. With a slight difference in enunciation, 'Lawyer' could be interpreted as, 'Liar'.",
          "This morning in the dining hall of my hotel I kept staring at the scene of a lady having her breakfast—first with a little disgust and then with sympathy.",
          "A lanky white woman who wore a soiled frock—looks like a street walker who spent the night at Hyde Park. She eats chewing and savouring every little atom of the crumb of bread. She is distressed at the diminishing quantity on her plate as she finishes her meal. Finally when the plate was empty she sat for a long time staring at her plate...I thought that the depressing worry that she must manage with this breakfast till it was evening, was casting a shadow over her weary eyes...one woman out of tens and thousands of the semi-starved living in the streets of London.",
          "Today I spent a lot of time in the British Museum. Most of the time was spent at the 'Egyptian Gallery'. (I have seen many Egyptian Mummies in the Cairo Museum). In a room here I saw, laid bare, the body of a man who lived 3500 years ago. This is not a body that has been mummified. A corpse that had remained under the hot sands of the desert for over three thousand years and remained undamaged. Apparently it was found in a place called Gabalin in Sudan. A naked creature lying curled up on its left side. The hair that remained on his head sticks to his scalp here and there like Kottadakka thol [the rind of dried areca nut]. The skin covering his skull has chapped in some places. The body appears in some parts greyed and blackened and in other parts mixed with the color of Thavidu [rice bran]. One can see clearly the skeleton beneath sticking to the parched and dried skin. Have decided to write a poem about that grandfather who reached London after a deep slumber of three thousand years in the desert.",
          "Sunday today.",
          "Strolled around in the afternoon and finally reached the lake in Hyde Park. This is the bathing zone of Hyde Park. There were thousands of scantily clad men and women lying around in the grass basking in the sun—like skinned prawns laid out to dry.",
        ],
      },
      {
        heading: "Soho Square",
        paragraphs: [
          "Soho square is the center of the black (particularly of the Negro clan) population in London. I reached there one evening. One can see everything illicit gathered around here. Amusement stalls showing nude dances, gambling houses and night clubs are three a yard ['dime a dozen'] here.",
          "I got into a theatre buying a ticket for six shillings. An amateur drama called 'The Latin Quarters' was on. Then came dances and variety shows.",
          "The program was packed with acrobatics and dialogues meant to tickle your heart and to make you laugh. Art is a far cry. But the settings and props in the theatre were the most modern. When I watched in amazement the revolving stage, the scenes in motion that vanish in a flash and the realistic visuals, I felt that I had not wasted six shillings.",
          "Among all the items, I liked just one; it was the solo act, 'A Bench in the Park' by a Negro girl called 'Laila More'.",
