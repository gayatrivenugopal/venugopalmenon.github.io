...
const Index = () => {
  ...
  const novelExcerpts = [
    ...
    },
    {
      ...
      teaser: "A traveller's eye on post-war London — its bombed ruins, hungry streets, stolen diamonds, and the Prince of Puthiyara.",
      slug: "city-of-london",
    },
  ];
      ...
      <div className={`relative rounded-t-lg ${work.imageAspect || "aspect-[3/4]"}`}>
        ...
        {work.backImage && (
          <div className="absolute inset-x-0 bottom-0 z-10 flex justify-center">
            <span className="bg-black/50 text-white text-xs font-raleway italic px-3 py-0.5 rounded-full opacity-60 group-hover:opacity-100 transition-opacity duration-300">
      ...
      <section className="py-20 bg-author-bg-section">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mt-2 flex justify-center">
            <img src={profile} alt="Venugopal Menon" className="w-40 h-40 rounded-full shadow-md object-cover border-4 border-author-accent" />
          </div><br /><br />
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <Card key={index} className="border-0 shadow-md bg-white">
                <CardContent className="p-8">
                  ...
                  <p className="text-lg text-author-primary leading-relaxed mb-6 font-serif italic">"{testimonial.quote}"</p>
                  <div className="border-t pt-6">
                    ...
                    <p className="text-sm text-author-accent font-medium">
                      <a href={testimonial.institutionUrl} target="_blank" rel="noopener noreferrer" className="hover:underline">{testimonial.institution}</a>
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-8 flex flex-col h-full">
                  <div className="mb-4">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-sm font-raleway font-medium text-author-accent uppercase tracking-wider">{article.publication}</span>
                    </div>
                ...
                <Card className="border-0 shadow-md hover:shadow-xl transition-all duration-300 h-full cursor-pointer bg-white">
                  <CardContent className="p-8 flex flex-col h-full">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-sm font-raleway font-medium text-author-accent uppercase tracking-wider">{item.genre}</span>
                    </div>
                    <h3 className="text-xl font-serif font-bold text-author-primary mb-3 leading-tight group-hover:text-author-accent transition-colors duration-200">{item.title}</h3>
                ...
                <Card className="border-0 shadow-md hover:shadow-xl transition-all duration-300 h-full cursor-pointer">
                  <CardContent className="p-8 flex flex-col h-full">
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className="text-sm font-raleway font-medium text-author-accent uppercase tracking-wider">{item.publication}</span>
                    </div>
                    <h3 className="text-xl font-serif font-bold text-author-primary mb-3 leading-tight group-hover:text-author-accent transition-colors duration-200">{item.title}</h3>
                    <p className="text-author-text-light leading-relaxed flex-1">{item.teaser}</p>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" variant="secondary" className="bg-author-accent hover:bg-elegant-gold text-author-primary px-8 py-3 text-lg font-raleway uppercase tracking-wider">
              <Link to="/contact">Send Email <ArrowRight className="ml-2 h-5 w-5" /></Link>
            </Button>
